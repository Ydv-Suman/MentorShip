    ...
    <div className="relative top-[18%] px-4 sm:px-0 flex justify-center">
      <div className="bg-green-300 rounded-2xl p-1 w-full max-w-md">
        <div className="bg-white border border-gray-400 rounded-2xl p-6 shadow-lg text-black w-full">
          <p className="text-gray-600 font-bold text-3xl text-center mb-4">LogIn</p>
          ...
          <p className="font-semibold">
            ...
            <input
              ...
              className="p-2 rounded-1xl bg-gray-300 w-full mt-1"
            />
          </p>
          ...
          <div className="flex justify-center mt-4">
            <button className="p-2 bg-blue-400 rounded-2xl w-20 h-10 cursor-pointer font-semibold">
              Log in
            </button>
          </div>
